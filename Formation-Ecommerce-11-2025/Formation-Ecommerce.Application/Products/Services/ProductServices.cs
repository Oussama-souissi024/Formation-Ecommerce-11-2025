...
{
    /// <summary>
    /// Service applicatif des produits : gère les cas d'usage du catalogue (CRUD produit, recherche par catégorie) et l'upload d'images.
    /// </summary>
    /// <remarks>
    /// Points pédagogiques :
    /// - Couche Application : orchestre la logique de haut niveau (ex: upload + persistance), mais délègue l'accès DB à <see cref="IProductRepository"/>.
    /// - <see cref="IFileHelper"/> isole la logique de gestion de fichiers (upload/suppression) pour éviter de la mettre dans les contrôleurs.
    /// - AutoMapper transforme DTOs ↔ entités pour limiter le couplage entre couches.
    /// </remarks>
