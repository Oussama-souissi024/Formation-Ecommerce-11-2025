...
{
    /// <summary>
    /// Contrôleur MVC des coupons : gestion des codes promo (liste, création, suppression).
    /// </summary>
    /// <remarks>
    /// Points pédagogiques :
    /// - Couche Web : prépare les vues et gère le flux utilisateur (GET formulaire / POST traitement).
    /// - <see cref="ICouponService"/> gère les opérations applicatives et les validations (ex: unicité du code, règles métier).
    /// - AutoMapper mappe ViewModels ↔ DTOs afin de garder une frontière claire entre UI et Application.
    /// </remarks>
