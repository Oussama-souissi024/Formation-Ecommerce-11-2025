...
{
    /// <summary>
    /// Contrôleur MVC des catégories : CRUD (liste, création, modification, suppression) des catégories du catalogue.
    /// </summary>
    /// <remarks>
    /// Points pédagogiques :
    /// - Couche Web : le contrôleur gère la navigation (Views) et la validation du ModelState.
    /// - <see cref="ICategoryService"/> encapsule les règles applicatives autour des catégories.
    /// - AutoMapper convertit entre ViewModels (UI) et DTOs (Application layer) pour découpler l'UI de la logique métier.
    /// </remarks>
