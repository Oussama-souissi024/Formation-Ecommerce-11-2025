...
{
    /// <summary>
    /// Contrat d'accès aux données d'authentification : encapsule les opérations liées aux utilisateurs/roles via Identity.
    /// </summary>
    /// <remarks>
    /// Points pédagogiques :
    /// - Cette interface représente la frontière entre Application et Infrastructure pour l'authentification.
    /// - Les implémentations reposent souvent sur ASP.NET Core Identity (UserManager/SignInManager/RoleManager).
    /// - Isoler ces opérations facilite le remplacement (autre fournisseur d'identité) et améliore la testabilité.
    /// </remarks>
