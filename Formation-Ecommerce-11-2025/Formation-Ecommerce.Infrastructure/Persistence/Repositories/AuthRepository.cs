...
{
    /// <summary>
    /// Repository d'authentification (Identity) : encapsule les opérations UserManager/SignInManager/RoleManager.
    /// </summary>
    /// <remarks>
    /// Points pédagogiques :
    /// - Couche Infrastructure : implémente <see cref="IAuthRepository"/> en s'appuyant sur ASP.NET Core Identity.
    /// - Le but est d'isoler les détails techniques (Identity) de la couche Application (<see cref="Formation_Ecommerce_11_2025.Application.Athentication.Interfaces.IAuthService"/>).
    /// - Les managers (User/Role/SignIn) sont des services Identity injectés via DI.
    /// </remarks>
