...
{
    /// <summary>
    /// Repository EF Core des commandes : persistance des en-têtes et détails de commande, lectures avec Include et mise à jour de statut.
    /// </summary>
    /// <remarks>
    /// Points pédagogiques :
    /// - Utilise le DbContext pour les requêtes avec graphes (Include OrderDetails -> Product).
    /// - Utilise aussi des repositories génériques pour factoriser Add/Update/SaveChanges sur OrderHeader.
    /// - La mise à jour de statut illustre un workflow simple : charger, modifier, persister.
    /// </remarks>
