...
{
    /// <summary>
    /// Repository EF Core des coupons : persistance et recherche de coupons (par Id, par code) utilisés pour appliquer des remises.
    /// </summary>
    /// <remarks>
    /// Points pédagogiques :
    /// - Couche Infrastructure : encapsule la logique d'accès aux données (EF Core) pour les coupons.
    /// - Hérite de <see cref="Repository{TEntity}"/> mais ajoute des opérations spécifiques (recherche par CouponCode).
    /// - Les contrôleurs/services ne manipulent pas le DbContext directement : ils passent par ce repository.
    /// </remarks>
