...
{
    /// <summary>
    /// Repository EF Core des produits : persistance des produits et requêtes de lecture (incluant la catégorie) + filtre par catégorie.
    /// </summary>
    /// <remarks>
    /// Points pédagogiques :
    /// - Couche Infrastructure : encapsule les accès DB pour Product (EF Core).
    /// - Les lectures utilisent <see cref="Microsoft.EntityFrameworkCore.EntityFrameworkQueryableExtensions.Include"/> pour charger la catégorie.
    /// - Expose une requête métier utile : obtenir les produits d'une catégorie.
    /// </remarks>
