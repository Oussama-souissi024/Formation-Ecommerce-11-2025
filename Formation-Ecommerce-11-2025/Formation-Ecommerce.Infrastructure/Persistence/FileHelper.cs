...
{
    /// <summary>
    /// Helper d'accès au système de fichiers (wwwroot) : upload et suppression de fichiers (ex: images produits).
    /// </summary>
    /// <remarks>
    /// Points pédagogiques :
    /// - Couche Infrastructure : ce composant isole la logique I/O (fichiers) pour éviter de la mettre dans les contrôleurs ou services.
    /// - <see cref="IWebHostEnvironment"/> donne accès aux chemins physiques (WebRootPath) côté serveur.
    /// - Les opérations de fichiers peuvent échouer (droits, disque, nom) : d'où le besoin de gérer les erreurs.
    /// </remarks>
