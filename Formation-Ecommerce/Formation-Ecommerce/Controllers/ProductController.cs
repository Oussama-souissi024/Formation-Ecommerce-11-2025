...
{
    /// <summary>
    /// Contrôleur MVC des produits : CRUD des produits et préparation des données nécessaires aux formulaires (ex: liste des catégories).
    /// </summary>
    /// <remarks>
    /// Points pédagogiques :
    /// - Le contrôleur orchestre : lecture via <see cref="IProductServices"/>, puis mapping vers les ViewModels.
    /// - <see cref="ICategoryService"/> est utilisé pour alimenter les dropdowns (SelectListItem) côté formulaire.
    /// - Le traitement "métier" (ex: gestion d'image, persistance, validations) doit rester côté service/application, pas dans le contrôleur.
    /// </remarks>
