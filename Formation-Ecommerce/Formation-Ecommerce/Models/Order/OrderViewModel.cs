...
namespace Formation_Ecommerce_11_2025.Models.Order
{
    ...
    /// <remarks>
    /// Points pédagogiques :
    /// - Ce ViewModel agrège les informations de l'en-tête de commande (client, montants, statut).
    /// - La liste <see cref="OrderDetails"/> permet à la vue d'afficher les lignes (articles) dans l'écran de détail.
    /// - Des champs techniques (Stripe) peuvent être présents ici pour l'affichage / suivi, sans polluer les entités Core.
    /// </remarks>
