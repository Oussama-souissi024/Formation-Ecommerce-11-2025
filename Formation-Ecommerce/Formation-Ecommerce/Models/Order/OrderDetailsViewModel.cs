...
namespace Formation_Ecommerce_11_2025.Models.Order
{
    ...
    /// <remarks>
    /// Points pédagogiques :
    /// - Chaque instance représente une ligne (produit, quantité, prix) affichée dans la vue de détail.
    /// - <see cref="TotalPrice"/> illustre un champ calculé côté UI (prix * quantité).
    /// - Les données proviennent généralement de la couche Application (DTOs) puis sont mappées pour l'affichage.
    /// </remarks>
