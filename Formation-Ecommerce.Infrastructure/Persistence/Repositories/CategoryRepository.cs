...
{
    /// <summary>
    /// Repository EF Core des catégories : implémente les opérations de persistance et requêtes liées aux catégories.
    /// </summary>
    /// <remarks>
    /// Points pédagogiques :
    /// - Couche Infrastructure : l'accès base est centralisé ici (EF Core), pas dans les services Application.
    /// - Hérite de <see cref="Repository{TEntity}"/> pour réutiliser des opérations CRUD de base.
    /// - Expose une requête spécifique : récupération de l'Id à partir du nom (utile pour filtrer des produits).
    /// </remarks>
