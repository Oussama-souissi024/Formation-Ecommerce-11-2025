...
{
    /// <summary>
    /// Point d'extension de la couche Infrastructure : enregistre les implémentations techniques (repositories, email, helpers) dans l'IoC container.
    /// </summary>
    /// <remarks>
    /// Points pédagogiques :
    /// - Le projet Web (composition root) appelle cette méthode pour "brancher" la couche Infrastructure.
    /// - On enregistre les implémentations concrètes derrière des interfaces (ex: repositories) afin de respecter l'inversion de dépendance.
    /// - Cette classe centralise le wiring DI pour éviter de disperser les enregistrements dans plusieurs endroits.
    /// </remarks>
