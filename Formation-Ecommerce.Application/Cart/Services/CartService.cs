...
{
    /// <summary>
    /// Service applicatif du panier : lecture du panier, ajout/mise à jour (upsert), application de coupon et suppression/vidage.
    /// </summary>
    /// <remarks>
    /// Points pédagogiques :
    /// - Couche Application : orchestre plusieurs sources de données (panier, produits, coupons) via des repositories.
    /// - <see cref="ICartRepository"/> gère la persistance du panier (header + details).
    /// - <see cref="IProductRepository"/> est utilisé pour hydrater les informations produit et calculer les prix.
    /// - <see cref="ICouponRepository"/> permet d'appliquer des règles de réduction selon le code coupon.
    /// </remarks>
