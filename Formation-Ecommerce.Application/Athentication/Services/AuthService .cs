...
{
    /// <summary>
    /// Service applicatif d'authentification : encapsule les cas d'usage liés aux comptes (inscription, connexion, rôles, tokens).
    /// </summary>
    /// <remarks>
    /// Points pédagogiques :
    /// - Couche Application : ce service contient l'orchestration des cas d'usage, sans dépendre directement du Web (Controller).
    /// - La persistance et les appels à ASP.NET Identity sont délégués à <see cref="IAuthRepository"/> (Infrastructure).
    /// - Les méthodes exposent des DTOs et des primitives pour garder une frontière nette entre UI et accès aux données.
    /// </remarks>
