...
{
    /// <summary>
    /// Service applicatif des catégories : gère les cas d'usage CRUD et la recherche d'une catégorie (ex: récupérer l'Id par nom).
    /// </summary>
    /// <remarks>
    /// Points pédagogiques :
    /// - Couche Application : fournit une API orientée cas d'usage pour la couche MVC, sans accès direct EF Core.
    /// - <see cref="ICategoryRepository"/> encapsule les opérations de persistance (Infrastructure).
    /// - AutoMapper transforme DTOs ↔ entités afin d'éviter de propager les entités EF côté UI.
    /// </remarks>
