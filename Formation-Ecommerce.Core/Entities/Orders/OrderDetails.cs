...
namespace Formation_Ecommerce_11_2025.Core.Entities.Orders
{
    ...
    /// <summary>
    /// Entité représentant une ligne de commande : un produit, une quantité et le prix facturé au moment de l'achat.
    /// </summary>
    /// <remarks>
    /// Points pédagogiques :
    /// - Le prix est dupliqué dans la ligne (<see cref="Price"/>) pour conserver l'historique même si le produit change plus tard.
    /// - La relation n-1 vers <see cref="OrderHeader"/> est portée par <see cref="OrderHeaderId"/>.
    /// - La navigation <see cref="Product"/> facilite le chargement (Include) côté Infrastructure.
    /// </remarks>
